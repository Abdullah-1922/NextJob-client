...
const HomeCategoryJobs = () => {
    ...
    return (
        <div className="dark:text-white my-10">
          <h3 className="uppercase text-2xl md:text-3xl lg:text-4xl font-bold my-5">Bid Jobs which suite you.</h3>
            <Tabs>
    ...
    <TabPanel>
      <div className="mt-10 ">
        ...
        {
           categoryData?.length>0 ?   <div className="grid gap-10 md:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          { categoryData?.map(card=> <CategoryCard card={card} key={card._id}></CategoryCard>)}
        </div>
            :<div className="flex justify-center items-center gap-5 md:gap-10 lg:gap-16 flex-col md:flex-row ">
            ...
            <div>
              <h6 className="text-4xl ">No Data Found</h6>
            </div>
           </div>
        }
      </div>
