...
const MyBids = () => {
    ...
    return (
        <div>
             
           {
            data?.length>0 ?  <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <h3 className="text-3xl my-4 text-center font-bold border-b-2 border-black w-fit mx-auto dark:text-white">My Bid History</h3>
                       ...
                       </thead>
        {
           ...
           <div>
             <h6 className="text-4xl dark:text-white">You bit history is empty</h6>
           </div>
          </div>
           }
        </div>
