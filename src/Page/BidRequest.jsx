...
const BidRequest = () => {
   ...
   const {data,refetch,isLoading,isFetching}=useBidRequest()
   if(!isLoading){
   refetch()
   }
   ...
   const handleRejected =(id)=>{
    ...
    return (
        <div className="my-10">
           ...
           {
            data?.length>0?  <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <h3 className="text-3xl my-4 text-center font-bold border-b-2 border-black w-fit mx-auto dark:text-white">BID REQUESTS FOR MY POST JOBS</h3>
