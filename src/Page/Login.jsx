    ...
    return (
      ...
      <div className=' py-10 px-3 md:p-10  dark:border flex justify-center w-fit mx-auto p-10 rounded-3xl bg-gradient-to-t from-green-200 via-cyan-200 to-blue-300   dark:from-slate-800 dark:via-slate-800 dark:to-slate-800'>
        <div className='relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none'>
          ...
          <p className='mt-1 block font-sans text-base font-normal leading-relaxed text-gray-700 dark:text-white antialiased'>
          ...
          <form
            ...
            <div className='mb-4 flex flex-col gap-6'>
              <div className='relative h-11 w-full min-w-[200px]'>
                <input
                  required
                  name='email'
                  className='peer  dark:text-white   border-black  h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50'
                />
              ...
              <div className='relative h-11 w-full min-w-[200px]'>
                <input
                  ...
                  className='peer h-full  dark:text-white border-black  w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50'
                />
            ...
            <div className='inline-flex items-center'>
              ...
              <label
                ...
                htmlFor='checkbox'>
                <p className='flex items-center font-sans text-sm font-normal leading-normal  dark:text-white  text-gray-700 antialiased'>
                  I agree the
                  <a
                    className='font-medium transition-colors  dark:text-blue-600 hover:text-pink-500'
                    href='#'>
            ...
            <p className='mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700  dark:text-white  antialiased'>
